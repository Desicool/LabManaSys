...
import { PostClaimFormModelType, FormToProcessModelType, FinancialProcessModelType, ClaimProcessModelType, ClaimFormChemicalModelType, MyChemicalModelType, PostPurchaseModelType } from 'umi';
...
export interface ConnectState {
  ...
  postPurchase: PostPurchaseModelType;
}
